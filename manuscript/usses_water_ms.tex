...
associated with high uncertainty, however, with credible intervals that
overlap zero (Table 1). Although the parameter estimates for the effect
of soil moisture overlap zero, the posterior distributions of the slopes
all shrank and shifted to more positive values relative to the prior
distributions (Fig. A2-2). Ecosystem functional response was similar
...
directional trend in the random year effects (Fig. A2-2).
