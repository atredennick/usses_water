...
calculate a \new{58}\% one-tailed probability that the estimate is
...
response under chronic \new{drought} was different from the control
...
\new{However, we do not want to over-interpret the significance of the slope offsets given that the full distributions of}
