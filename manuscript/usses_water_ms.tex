...
Therefore, we used a version of the SOILWAT soil moisture model}
\citep{Sala1992a}
...
\new{(on average 25\% lower) relative to control plots} (Fig. 2C),
...
our statistical model. \new{For example,} \citet{LaPierre2016}
