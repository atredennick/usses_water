...
\new{The model was parameterized sing generic sagebrush stepped parameters and local soil texture, soil bulk density, and precipitation data} [@Kleinhesselink2017b].
\new{We used the locally parameterized SOILWAT model generate daily soil moisture predictions for the duration of the experiment, but only used SOILWAT predictions where there were gaps in our data (Fig. Sx).}
