...
ANPP was slightly higher in irrigation plots \new{(on average 17\% higher)} and slightly lower in drought plots \new{(on average 23\% lower) relative to control plots} (Fig. 2C), corresponding to estimated soil volumetric water content (VWC) differences among treatments (Fig. 2B).
...
\new{Sensitivity of ANPP to irrigation was constant over the course of our experiment (Fig. 3C). Sensivitity of ANPP to drought, however, grew over time (\emph{P} = 0.0002; Fig. 3C)}.
