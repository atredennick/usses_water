...
We then modeled the daily deviation \new{($\Delta x^*_\text{trt.}$)} from ambient conditions of the drought and irrigation treatments using a linear mixed effects model with independent variables for treatment, season (winter, spring, summer, fall), rainfall, and all two-way interactions. 
...
We then estimated average daily soil moisture in the treated plots based on the average daily ambient soil moisture \new{and the model predicted daily deviation for each treatment ($\Delta x^*_\text{trt.}$)}.
