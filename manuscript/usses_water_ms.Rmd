...
Using the methods described by @Lemoine2016, we calculated the percent reduction and increase of annual precipitation necessary to reach the 1\% and 99\% extremes of the historical precipitation regime at our site (Fig. A5-1).
The 1\% quantile of precipitation at our site is 151 mm, a 50% reduction from the mean, and the 99\% quantile is 532 mm, a 77\% increase from mean growing season precipitation (Appendix 5).
