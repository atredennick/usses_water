...
These statistical issues of missing potentially important covariates could explain the within-year spread of ANPP (Fig 2C, Fig. 3B) and the resulting uncertain relationship we observed between soil moisture and ANPP across all treatments (Table 1, Fig. A2-2).
...
In so doing, the dominant species in our ecosystem avoid "boom and bust" cycles, which corresponds to the weak effect of soil moisture on ANPP (i.e., the Bayesian credible intervals for $\beta$ in Eq. 1 overlapping zero).
...
Avoiding high biomass production in wet years could benefit species in the long run if climate conditions are variable.
...
In conclusion, our results suggest the species in our focal plant community are tolerant of drought conditions and bet hedgers in wet conditions.
