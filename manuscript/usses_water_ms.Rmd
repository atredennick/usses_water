...
We also took readings in 12 (2015), 15 (2012, 2013, 2014), or 16 (2016) calibration plots adjacent to the experimental site, in which we harvested all aboveground biomass produced in the current year (we excluded litter and standing dead material), dried it to a constant weight at 60$^{\circ}$C, and weighed it to estimate ANPP. We harvested at peak green biomass each year, typically in late June.
