...
\new{We then modeled these daily deviations ($\Delta x_\text{trt.}$)} from ambient conditions using a linear mixed effects model with independent variables for treatment (irrigation or drought), season (winter, spring, summer, fall), rainfall, and all two-way interactions. 
...
\new{The dominance of our site by the shrub \emph{A. tripartita} may explain why our results do not conform to broader patterns of grassland sensitivity to precipitation manipulations} [e.g., @Huxman2004; @Knapp2015; @Wilcox2017].
