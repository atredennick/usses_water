...
We used nonmetric multidimensional scaling (NMDS) based on Bray-Curtis distances to see if community composition differed among treatments through time.
...
ANPP was highly variable within years (Fig. 2C).
