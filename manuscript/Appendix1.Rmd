...
```{r rac_plots, echo=FALSE, include=TRUE, message=FALSE, warning=FALSE, fig.height=3, fig.cap="Rank abundance curves for perennial species. Basal area (grasses) or canopy cover (shrubs and forbs) of individuals was summed withnin years and plots, and then the total area values were averaged across years and plots for each treatment.", fig.pos="h",fig.align="center"}
####
