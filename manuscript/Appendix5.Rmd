...
As with our ANPP-model results, the positive offset for the drought treatment does not result in a significantly different slope once applied to the control slope.
