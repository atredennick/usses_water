...
\response{These are all good suggestions. Reviewer 2 agreed that the paper would benefit from a broader introduction, which we have added (lines xx-xx). We have also added a brief introduction to the idea that domoninant species play a large role in determining ecosystem functioning (lines xx-xx).}
