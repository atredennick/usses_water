...
Lines 71-72. While this is an excellent and clear definition of ‘ecosystem functional response’, I think it might be prudent at some point to explain why the authors are using soil moisture as an explanatory variable for ANPP instead of [precipitation]. I agree that soil moisture is generally a better predictor of ANPP than direct precipitation measures, but most of the articles the authors cite refer to 
ANPP-precipitation relationships, so taking a moment to explain why they are using soil moisture would be warranted. 
